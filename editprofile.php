...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Edit Profile - Student Record System</title>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="course">
              <option value="BSBA" <?php echo $course == 'BSBA' ? "selected": ""; ?>>CSC 101</option>
              <option value="BSOA" <?php echo $course == 'BSOA' ? "selected": ""; ?>>CSC 103</option>
              <option value="BSIT" <?php echo $course == 'BSIT' ? "selected": ""; ?>>CSC 104</option>
              <option value="BSCS" <?php echo $course == 'BSCS' ? "selected": ""; ?>>CSC 106</option>
              <option value="BSCE" <?php echo $course == 'BSCE' ? "selected": ""; ?>>CSC 108</option>
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="yrlevel">
			...
			<option <?php echo $yrlevel == '4th year' ? "selected": ""; ?>>5th year</option>
          </select>
